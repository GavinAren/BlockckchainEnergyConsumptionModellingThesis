...
This chapter constitutes the technical section of this study. It documents the development of the model being proposed, following the steps in \sref{MethodologySteps}. Next, this model and two others are implemented to obtain comparative results which are then evaluated. 
% ____________________________________________________________________________
...
\begin{table}[htb!]
    ...
    \caption{Table adapted from the CCRI report \cite{CryptoCarbonRatingsInstitute2022TheNetwork}, details hardware configurations 4-6, representing a low, mid and high-tier node, used in their experiment.}
