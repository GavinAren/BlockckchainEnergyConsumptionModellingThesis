...
\begin{figure}[!htb]
    ...
    \label{Figure:PaypalEthElectrciityPlot}
\end{figure}

\fref{Figure:PaypalEthElectrciityPlot} shows that Ethereum 2.0 is impressively close to Paypal's electricity consumption while maintaining decentralisation, according to Model A.
