...
\cline{3-6}
 &
   &
  \multicolumn{2}{l"}{\textbf{My Model}} &
...
\multicolumn{1}{|l|}{} &
  ...
  23.25 \\ \hline
\end{tabular}
\caption{The results (best guess values) obtained from implementing the model proposed in this paper, as well as 2 other models, all using the same data in section \ref{postSyncEnergyImplementation}.}
