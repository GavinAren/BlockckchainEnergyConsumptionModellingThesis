...
Through extensive data gathering of contemporary data, Model A, as well as 2 models from other studies, are implemented in this section.


\subsection{Implementing Model A}
...
Results from the aforementioned models are presented in a comparable format in \tref{Table:FinalResults}.
\clearpage
% -----------------------------------------------
% RESULTS  TABLEEEE
% ----------------------------------------------------------------
...
The UCL model seems to be overestimating the consumption values. This can be attributed to the lack of complexity in their model as a result of generalising it for all PoS blockchains.
