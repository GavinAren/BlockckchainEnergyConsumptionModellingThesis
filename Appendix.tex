...
1            & Go-Eth          & \begin{tabular}[c]{@{}l@{}}Recommended Specs \\ for Solo Validator\end{tabular}             & \begin{tabular}[c]{@{}l@{}}Quad Core or Dual Core \\ Hyperthreaded Processor, \\ 2TB SSD , \textgreater{}16GB memory\end{tabular} & Any                                                          & NA                                                          & \cite{Ethereum/go-ethereum:Protocol} \\ \midrule
2            & Go- Eth         & \begin{tabular}[c]{@{}l@{}}Recommended Specs \\ for Archive Nodes\end{tabular}              & \begin{tabular}[c]{@{}l@{}}Quad Core or Dual Core \\ Hyperthreaded Processor, \\ 12TB SSD, \textgreater{}16GB memory\end{tabular} & Any                                                          & NA                                                          & \cite{Ethereum/go-ethereum:Protocol} \\ \midrule
3            & Go-Eth          & \begin{tabular}[c]{@{}l@{}}Minimum Recommended \\ Specs for Validator nodes\end{tabular}    & \begin{tabular}[c]{@{}l@{}}Dual Core Hyperthreaded, \\ 1TB SSD, \textgreater{}4GB memory\end{tabular}                             & Any                                                          & NA                                                          & \cite{Ethereum/go-ethereum:Protocol} \\ \midrule
...
\end{tabular}
\caption{Data was collected on various users running their validator nodes, focusing on measured energy consumption for the given hardware configuration. Continued in \tref{Table:HardwareTable2}.}
...
\end{tabular}
\caption{Continuation of \tref{Table:HardwareTable1}. Data was collected on various users running their validator nodes, focusing on measured energy consumption for the given hardware configuration.}
