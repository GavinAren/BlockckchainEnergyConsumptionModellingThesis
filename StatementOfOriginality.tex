...
\fbox{\begin{minipage}{\linewidth}
\textbf{I have acknowledged all sources, and identified any content taken from elsewhere. In particular, tables and images used from other papers have been attributed to their relevant authors in the caption and all Python packages used have been cited.}
\end{minipage}} \\ 

\textrm{You can consult with module teaching staff/demonstrators, but you should not show anyone 
